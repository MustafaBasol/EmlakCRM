          ...
          {users.length === 0 ? (
            ...
            users.map((user) => (
              ...
              >
                ...
                <TableCell>
                  {user.role === "ADMIN" ? (
                    <span className="inline-flex items-center rounded-md border border-blue-200 bg-blue-50 px-2.5 py-0.5 text-[12px] font-bold text-[#1D4ED8]">
                      YÖNETİCİ
                    </span>
                  ) : (
                    <span className="inline-flex items-center rounded-md border border-[#E2E8F0] bg-[#F1F5F9] px-2.5 py-0.5 text-[12px] font-bold text-[#475569]">
                      DANIŞMAN
                    </span>
                  )}
                </TableCell>
